...
public class lsEnergyClass : MonoBehaviour {
	...
	public void OnApplicationFocus(bool flag) {
        ...
        if (flag) { 
            ...
            //перенесено из setreward for coins, тк не работает
            if (GameObject.Find("root/static/coins/coinsLabel") != null) GameObject.Find("root/static/coins/coinsLabel").GetComponent<UILabel>().text =  ctrProgressClass.progress["coins"].ToString();
