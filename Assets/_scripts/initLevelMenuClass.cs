...
public class initLevelMenuClass : MonoBehaviour {
	...
	public GameObject shieldMarketButton;
	...
	void Start () {
		...
		if (ctrProgressClass.progress["lastLevel"] >= 5 && ctrProgressClass.progress["firstPurchase"] == 0)
			shieldMarketButton.SetActive(true);
		else
